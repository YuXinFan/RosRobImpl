        ...
        if small_sensor >= 800:
            ...
            if (userTime - rawTime[-1]) >= averageTime/2:
                ...
                if (userTime - rawTime[-1]) <= averageTime*3/4:
                    ...
                    elif big_sensor >= 310:# this value is charged by sensor.
                        twist.linear.x = 0.1
                        angular = big_sensor/360.000 + 0.009*(big_sensor - averageDis) + 0.0014*abs(sum(fivePoint)/4.000)
                ...
                #left side of the front
                    ...
                    if len(distanceList) == 0:
                        ...
                        twist.angular.z = angular #print twist.angular.z
        else:
